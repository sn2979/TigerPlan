...
def sorting_key(course, search_query):
    ...
    # print(search_query)
        ...
        print("An error occurred while sorting courses:", e)
        raise e
...
def search_courses(search_query):
    try:
        ...
        print("An error occurred while searching courses:", e)
        raise Exception("An error occurred while searching courses:", e)
    # else:
    #     return None
